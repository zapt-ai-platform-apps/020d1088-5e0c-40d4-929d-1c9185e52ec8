      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-gray-900">Choose Your Assessment Path</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-primary">Family Protection</h3>
                ...
                <div className="mt-6">
                  <Link to="/assessment/family" className="btn-primary w-full text-center cursor-pointer">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-primary">Business Protection</h3>
                <p className="mt-2 text-gray-600">
                ...
                <div className="mt-6">
                  <Link to="/assessment/business" className="btn-primary w-full text-center cursor-pointer">
          ...
          <div className="mt-12 text-center">
            ...
            <p className="mt-4 text-gray-600">
              Learn more about <Link to="/products" className="text-primary hover:text-primary-dark font-medium">protection insurance products</Link> before starting.
            </p>
          </div>
        </div>
      </div>
