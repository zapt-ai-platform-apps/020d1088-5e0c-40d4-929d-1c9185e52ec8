...
import { businessQuestions } from '@/modules/assessment/businessQuestions';
...
export default function BusinessAssessment() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < businessQuestions.length - 1) {
      ...
      sessionStorage.setItem('businessAssessmentAnswers', JSON.stringify(answers));
      navigate('/assessment/results', { state: { assessmentType: 'business', answers } });
    }
  };
  ...
  return (
    <div>
      <PageHeader 
        title="Business Protection Assessment"
        description="Help us understand your business protection insurance needs by answering a few questions"
      />
        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            <AssessmentProgress 
              ...
              totalSteps={businessQuestions.length} 
            />
          </div>
